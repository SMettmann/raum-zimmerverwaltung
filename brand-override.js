(function(){
  ...
  if(!bookingPage){
    ...
    window.addEventListener('load',()=>{
      const locationFilterScript=document.createElement('script');
      locationFilterScript.src='location-filter-final.js';
      document.head.appendChild(locationFilterScript);
    },{once:true});
  }
})();
