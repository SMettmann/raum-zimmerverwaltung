...
const ownerEntry=fs.readFileSync('worker/owner-protection-entry.js','utf8');
...
assert.ok(ownerEntry.includes("import app from './password-entry.js'"),'Der Hauptadministrator-Schutz muss die Passwort-Schicht weiterverwenden.');
