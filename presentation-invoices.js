(function(){
  ...
  window.startPresentation=function(...args){
    ...
    if(settings?.org!=='Tagungs- & Gästehaus Beispiel')return result;
    if(!Array.isArray(invoices)||invoices.some(i=>i.id==='i2'))return result;
    ...
    persistLocal();
    renderAll();
    toast('Präsentationsdaten mit Rechnungen geladen');
    return result;
  };
})();
